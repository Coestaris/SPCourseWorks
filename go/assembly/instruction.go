...
type instruction struct {
	...
	// SIB section
	// REG field flags if SIB was set
	sib byte
...
var instructions = []types.Instruction{
	...
	// 7E cb | JNG rel8 | 1
	NewInstruction("jng", 0x7E | 0b1, []int{lexeme.LabelBackward}, immSize(1)),
	// OF 8E cw | JNG rel16 | 1
	NewInstruction("jng", 0x8E, []int{lexeme.LabelForward}, immSize(4), expansionPrefix()),
	// FF /4 | JMP r/m16 | 1
	NewInstruction("jmp", 0xFF, []int{lexeme.LabelForward}, regOpCodeExtension(4),
		operandSizePrefix()),

	// 84 /r | TEST r/m8, r8 | test ES:Hex1, bh
	NewInstruction("test", 0x84 | 0b1, []int{lexeme.Mem, lexeme.Register8}),
}
